...
export function HeroSection() {
  return (
    <section id="home" className="pt-40 pb-20 relative overflow-hidden bg-black">
      ...
      <div className="absolute -top-24 -left-48 w-96 h-96 bg-crm-primary/20 rounded-full filter blur-3xl opacity-40 animate-background-pan"></div>
      <div className="absolute -bottom-24 -right-48 w-96 h-96 bg-pulse-primary/20 rounded-full filter blur-3xl opacity-40 animate-background-pan delay-3000"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        <div className="mt-20 max-w-5xl mx-auto animate-float">
            <div className="relative rounded-2xl p-2 bg-gradient-to-b from-white/10 to-transparent shadow-2xl shadow-primary/20 animate-fade-in-up animation-delay-900">
                <DashboardMockup />
            </div>
        </div>
      </div>
