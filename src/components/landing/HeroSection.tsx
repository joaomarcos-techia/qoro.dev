...
export function HeroSection() {
  return (
    <section id="home" className="pt-40 pb-20 relative overflow-hidden bg-black">
      ...
      <div className="absolute -bottom-24 -right-48 w-96 h-96 bg-pulse-primary/20 rounded-full filter blur-3xl opacity-40 animate-background-pan" style={{ animationDelay: '3s' }}></div>
