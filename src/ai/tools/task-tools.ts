...
export const listTasksTool = ai.defineTool(
    {
        name: 'listTasksTool',
        description: 'Lista todas as tarefas da organização. Use esta ferramenta para responder a perguntas sobre o que precisa ser feito, produtividade, prazos ou itens pendentes.',
...
export const createTaskTool = ai.defineTool(
    {
        name: 'createTaskTool',
        description: 'Cria uma nova tarefa. Use quando o usuário pedir para ser lembrado de algo, para criar um item de "a fazer", ou para agendar uma atividade específica.',
