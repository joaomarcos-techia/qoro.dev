...
import { Send, BrainCircuit, Loader } from 'lucide-react';
...
export default function PulsePage() {
  ...
  const handleSendMessage = async (e: FormEvent) => {
    ...
    try {
        ...
        // If it was a new conversation, the ID is returned. We store it for subsequent messages in this session.
  ...
  const handleSuggestionClick = (question: string) => {
    setInput(question);
    // Automatically focus the textarea after suggestion click
    const textarea = document.querySelector('textarea');
    if (textarea) textarea.focus();
  }

  return (
    <div className="flex flex-col flex-1 max-w-4xl mx-auto h-[calc(100vh-120px)]">
