      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Cadastre e gerencie os serviços cobrados por hora que sua empresa oferece.
          </p>
        </div>
        <Dialog open={isModalOpen} onOpenChange={handleModalOpenChange}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <ProductForm onProductAction={handleProductAction} product={selectedProduct} defaultType='service' />
          </DialogContent>
        </Dialog>
      </div>
